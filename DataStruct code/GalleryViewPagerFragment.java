...
/*
ViewPager is widget that allows for the swipeable functionality of gallery to move between images.
It works by loading 3 instances of the Fragment to display (ImageDetailFragment), every time one image
is viewed: current image, the image to the left, the image to the right. It allows for smooth transitions
between images. Internally handled.
 */
...
public class GalleryViewPagerFragment extends Fragment {
    ...
    //In this method, the ViewPager object is created and GalleryPagerAdapter is set as its adapter.
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ViewPager viewPager = (ViewPager) view.findViewById(R.id.coffee_view_pager);
